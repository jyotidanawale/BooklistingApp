                                            ...
                                            <View style={{ margin: hp('3%'), flexDirection: 'row' }}>
                                                <View style={{ flexDirection: 'column', width: wp('60%'), }}>
                                                    <View style={{ flexDirection: 'row' }}>
                                                        <Text style={{ color: 'black', fontWeight: 'bold', fontSize: hp('2%') }}>Book Name : </Text>
                                                        <Text style={{ color: color.grayColor, fontSize: hp('2%') }}>{item.name}</Text>
                                                    </View>
                                                    <View style={{ flexDirection: 'row' }}>
                                                        <Text style={{ color: 'black', fontWeight: 'bold', fontSize: hp('2%') }}>Author Name : </Text>
                                                ...
                                                <TouchableOpacity onPress={() => { this.removeItemfromCart(item) }} style={{ width: wp('10%'), height: hp('6%'), alignItems: 'flex-end' }}>
                                                    <Image style={[{ width: wp('6%'), height: wp('6%'), tintColor: 'purple' }]}
